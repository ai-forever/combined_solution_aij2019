...
class Solver(object):
    ...
    def load(self, path="data/models/solvers/solver23"):
    ...
    def save(self, path="data/models/solvers/solver23"):
    ...
    def ensemble(self, X, y, label):
        ...
        print(
            "Precision: {0:6.2f}".format(
                precision_score(self.y_test, predictions, average="macro")
            )
        )
        print(
            "Recall: {0:6.2f}".format(
                recall_score(self.y_test, predictions, average="macro")
            )
        )
        print(
            "F1-measure: {0:6.2f}".format(
                f1_score(self.y_test, predictions, average="macro")
            )
        )
